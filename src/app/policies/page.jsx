...
export default function Page() {
  ...
  return (
    <section
      className={`w-full flex flex-col items-center justify-center mt-10 pt-20 pb-10 transition-colors duration-500 ${theme === "dark" ? "bg-gray-800 text-white" : "bg-[#F4F4F4] text-black"}`}
    >
      <div className="w-full max-w-screen-xl">
        <div className="flex flex-col md:flex-row justify-center">
          <div className="flex flex-col gap-8 justify-center w-full md:w-2/3">
            <h1 className="text-5xl font-bold underline mb-4 text-center">
              Políticas Generales
            </h1>
