      ...
      <div className='w-full max-w-screen-xl'>
        <div className='flex flex-col md:flex-row justify-center'>
          <div className='flex flex-col gap-8 justify-center w-full md:w-2/3'>
            <h1 className='text-5xl font-bold underline mb-4 text-center'>Políticas para arriendo de canchas de Pádel</h1>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
                ...
                <p>Puedes reservar una cancha de pádel con hasta 30 días de antelación. Las reservas deben ser confirmadas al menos 24 horas antes del tiempo de juego.</p>
              </div>
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
              ...
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
                ...
                <p>Te pedimos que llegues a tiempo para tu reserva de pádel. Si llegas tarde, el tiempo perdido no será reembolsado.</p>
              </div>
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
                <h2 className='text-2xl font-semibold mb-2'>Responsabilidad</h2>
                <p>Los usuarios son responsables de cualquier daño causado a las instalaciones durante el tiempo de su reserva de pádel.</p>
              </div>
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
                <h2 className='text-2xl font-semibold mb-2'>Condiciones Climáticas</h2>
                <p>En caso de mal tiempo, podrás reprogramar tu reserva de pádel sin penalización.</p>
              </div>
              <div className='p-4 bg-white shadow-md rounded-md transform transition-transform hover:scale-105 hover:shadow-lg'>
